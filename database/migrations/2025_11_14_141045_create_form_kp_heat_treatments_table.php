...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('form_kp_heat_treatment', function (Blueprint $table) {
            ...
            $table->json('foto_heattreatment')->nullable();
            $table->string('jenis_bejana')->nullable();
            $table->string('lokasi')->nullable();
            $table->string('jenis_tipe')->nullable();
            $table->json('foto_billiet')->nullable();
            $table->decimal('dimensi_bakar_maks', 10, 4)->nullable();
            $table->decimal('berat_bakar_maks', 10, 4)->nullable();
            ...
            $table->json('foto_jalur_furnance')->nullable();
            $table->integer('jumlah_jalur_operasi')->nullable();
            $table->decimal('panjang_jalur_operasi', 10, 4)->nullable();
            $table->string('dimensi_total_furnance')->nullable();
            $table->string('dimensi_efektif_furnance')->nullable();
            ...
            $table->string('konstruksi_pondasi_furnance', 100)->nullable();
            $table->text('keterangan_pondasi')->nullable();
            $table->json('foto_pondasi')->nullable();
            $table->string('furnance_shell', 100)->nullable();
            $table->text('keterangan_furnance_shell')->nullable();
            $table->json('foto_furnance_shell')->nullable();
            ...
            $table->string('tutup_furnance', 100)->nullable();
            $table->text('keterangan_tutup_furnance')->nullable();
            $table->json('foto_tutup_furnance')->nullable();
            $table->string('refractory', 100)->nullable();
            $table->text('keterangan_refractory')->nullable();
            $table->json('foto_refractory')->nullable();
            $table->string('furnance_sidewalls_refractory', 100)->nullable();
            $table->text('keterangan_sidewalls_refractory')->nullable();
            $table->json('foto_sidewalls_refractory')->nullable();
            $table->string('furnance_hearth_refractory', 100)->nullable();
            ...
            $table->string('furnance_top_igniter', 100)->nullable();
            $table->text('keterangan_furnance_top_igniter')->nullable();
            $table->json('foto_furnance_top_igniter')->nullable();
            ...
            $table->string('furnance_top_bleeding', 100)->nullable();
            $table->text('keterangan_furnance_top_bleeding')->nullable();
            $table->json('foto_furnance_top_bleeding')->nullable();
