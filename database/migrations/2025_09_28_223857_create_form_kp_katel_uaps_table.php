...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('form_kp_katel_uap', function (Blueprint $table) {
            ...
            $table->decimal('tekanan_desain', 10, 3)->nullable();
            $table->decimal('tekanan_kerja', 10, 3)->nullable();
            $table->string('kapasitas_uap')->nullable();
            $table->decimal('luas_pemanasan', 10, 3)->nullable();
            $table->decimal('work_temperature', 10, 3)->nullable();
            $table->string('bahan_bakar')->nullable();
            $table->string('lokasi')->nullable();
            $table->json('foto_safety_valve')->nullable();
            $table->decimal('safety_valve1_membuka', 10, 3)->nullable();
            $table->decimal('safety_valve1_menutup', 10, 3)->nullable();
            $table->decimal('safety_valve2_membuka', 10, 3)->nullable();
            $table->decimal('safety_valve2_menutup', 10, 3)->nullable();
