<x-layout>
    ...
    <div class="p-4 bg-white rounded-lg shadow-md">
        <form action="{{ route('form_kp.papa.crane.update', $formKpCrane->id) }}" method="POST" class="space-y-4" enctype="multipart/form-data" onsubmit="return confirm('Update data?')">
            @csrf
            @method('PUT')
                    ...
                    <div class="w-full md:w-[48%]">
                        <div class="relative">
                            ...
                            <input id="datepicker-autohide" name="tanggal_pemeriksaan" placeholder="Tanggal Pemeriksaan"
                                value="{{ old('tanggal_pemeriksaan', optional($formKpCrane->tanggal_pemeriksaan)->format('d-m-Y')) }}"
            ...
            <div>
                ...
                {{-- foto lama --}}
                @if($formKpCrane->foto_informasi_umum)
                @php $oldFiles = json_decode($formKpCrane->foto_informasi_umum, true); @endphp
            ...
            <div>
                ...
                <input type="text" disabled class="block w-full px-3 py-2 mt-1 bg-gray-200 border border-gray-400 rounded-md shadow-md cursor-not-allowed focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ $formKpCrane->jobOrderTool->jobOrder->nama_perusahaan }}">
            </div>

            {{-- Kapasitas --}}
            <div>
                <label class="block text-sm font-medium text-gray-700">Kapasitas</label>
                <input type="text" disabled class="block w-full px-3 py-2 mt-1 bg-gray-200 border border-gray-400 rounded-md shadow-md cursor-not-allowed focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ $formKpCrane->jobOrderTool->kapasitas }}">
            </div>

            {{-- Model/Tipe --}}
            <div>
                <label class="block text-sm font-medium text-gray-700">Model/Tipe</label>
                <input type="text" disabled class="block w-full px-3 py-2 mt-1 bg-gray-200 border border-gray-400 rounded-md shadow-md cursor-not-allowed focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ $formKpCrane->jobOrderTool->model }}">
            </div>

            {{-- No.Seri --}}
            <div>
                <label class="block text-sm font-medium text-gray-700">No. Seri/Unit</label>
                <input type="text" disabled class="block w-full px-3 py-2 mt-1 bg-gray-200 border border-gray-400 rounded-md shadow-md cursor-not-allowed focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ $formKpCrane->jobOrderTool->no_seri }}">
            </div>

            {{-- Pabrik Pembuat --}}
            <div>
                <label for="pabrik_pembuat" class="block text-sm font-medium text-gray-700">Pabrik Pembuat</label>
                <input type="text" name="pabrik_pembuat" placeholder="Pabrik Pembuat" id="pabrik_pembuat" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('pabrik_pembuat') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('pabrik_pembuat', $formKpCrane->pabrik_pembuat) }}">
            ...
            <div>
                ...
                <input type="text" name="lokasi" placeholder="Lokasi" id="lokasi" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('lokasi') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('lokasi', $formKpCrane->lokasi) }}">
                @error('lokasi')
                <div class="text-xs text-red-600">
                    {{ $message }}
                </div>
            ...
            <div>
                ...
                <input type="text" name="tahun_pembuatan" placeholder="Tahun Pembuatan" id="tahun_pembuatan" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('tahun_pembuatan') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('tahun_pembuatan', $formKpCrane->tahun_pembuatan) }}">
            ...
            <div>
                ...
                <input type="number" step="any" name="tinggi_angkat_maksimum" placeholder="Tinggi Angkat Maksimum" id="tinggi_angkat_maksimum" 
                    class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('tinggi_angkat_maksimum') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" 
                    value="{{ old('tinggi_angkat_maksimum', $formKpCrane->tinggi_angkat_maksimum) }}">
            ...
            <div>
                ...
                <input type="number" step="any" name="kecepatan_hosting" placeholder="Kecepatan Hosting" id="kecepatan_hosting" 
                    class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('kecepatan_hosting') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" 
                    value="{{ old('kecepatan_hosting', $formKpCrane->kecepatan_hosting) }}">
            ...
            <div>
                ...
                <input type="number" step="any" name="kecepatan_treversing" placeholder="Kecepatan Treversing" id="kecepatan_treversing" 
                    class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('kecepatan_treversing') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" 
                    value="{{ old('kecepatan_treversing', $formKpCrane->kecepatan_treversing) }}">
            ...
            <div>
                ...
                <input type="number" step="any" name="kecepatan_travelling" placeholder="Kecepatan Travelling" id="kecepatan_travelling" 
                    class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('kecepatan_travelling') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" 
                    value="{{ old('kecepatan_travelling', $formKpCrane->kecepatan_travelling) }}">
            ...
            <div>
                ...
                <input type="number" step="any" name="panjang_span" placeholder="Panjang Span" id="panjang_span" 
                    class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('panjang_span') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" 
                    value="{{ old('panjang_span', $formKpCrane->panjang_span) }}">
                @error('panjang_span')
                <div class="text-xs text-red-600">{{ $message }}</div>
                @enderror   
            </div>
            ...
            <div>
                ...
                {{-- foto lama --}}
                @if($formKpCrane->foto_rantai)
                @php $oldFiles = json_decode($formKpCrane->foto_rantai, true); @endphp
                @if(is_array($oldFiles))
                <div class="flex flex-wrap gap-2 mb-2">
                    @foreach($oldFiles as $oldFile)
                    <img src="{{ asset('storage/' . $oldFile) }}"
                    ...
                    @for ($i = 1; $i <= 6; $i++)
                        <div>
                            <input type="number" step="any" name="panjang_rantai{{ $i }}" placeholder="Panjang {{ $i }}" id="panjang_rantai{{ $i }}"
                                ...
                                value="{{ old('panjang_rantai'.$i, $formKpCrane->{'panjang_rantai'.$i}) }}">
            ...
            <div>
                ...
                {{-- foto lama --}}
                @if($formKpCrane->foto_wire_rope)
                @php $oldFiles = json_decode($formKpCrane->foto_wire_rope, true); @endphp
                @if(is_array($oldFiles))
                <div class="flex flex-wrap gap-2 mb-2">
                    @foreach($oldFiles as $oldFile)
                    <img src="{{ asset('storage/' . $oldFile) }}"
                    ...
                    @for ($i = 1; $i <= 6; $i++)
                        <div>
                            <input type="number" step="any" name="panjang_wire_rope{{ $i }}" placeholder="W{{ $i }}" id="panjang_wire_rope{{ $i }}"
                                ...
                                value="{{ old('panjang_wire_rope'.$i, $formKpCrane->{'panjang_wire_rope'.$i}) }}">
            ...
            <div>
                ...
                {{-- foto lama --}}
                @if($formKpCrane->foto_hook)
                @php $oldFiles = json_decode($formKpCrane->foto_hook, true); @endphp
                @if(is_array($oldFiles))
                <div class="flex flex-wrap gap-2 mb-2">
                    @foreach($oldFiles as $oldFile)
                    <img src="{{ asset('storage/' . $oldFile) }}"
                    ...
                    @foreach ($hooks as $hook)
                        <div>
                            <input type="number" step="any" name="panjang_hook{{ $hook }}" placeholder="Panjang Hook {{ $hook }}" id="panjang_hook{{ $hook }}"
                                ...
                                value="{{ old('panjang_hook'.$hook, $formKpCrane->{'panjang_hook'.$hook}) }}">
            ...
            <div>
                ...
                {{-- foto lama --}}
                @if($formKpCrane->foto_pulley)
                @php $oldFiles = json_decode($formKpCrane->foto_pulley, true); @endphp
                @if(is_array($oldFiles))
                <div class="flex flex-wrap gap-2 mb-2">
                    @foreach($oldFiles as $oldFile)
                    <img src="{{ asset('storage/' . $oldFile) }}"
                    ...
                    @foreach ($pulleys as $p)
                        <div>
                            <input type="number" step="any" name="panjang_pulley{{ $p }}" placeholder="{{ $p }}" id="panjang_pulley{{ $p }}"
                                ...
                                value="{{ old('panjang_pulley'.$p, $formKpCrane->{'panjang_pulley'.$p}) }}">
            ...
            <div>
                ...
                {{-- foto lama --}}
                @if($formKpCrane->foto_loadtest)
                @php $oldFiles = json_decode($formKpCrane->foto_loadtest, true); @endphp
                @if(is_array($oldFiles))
                <div class="flex flex-wrap gap-2 mb-2">
                    @foreach($oldFiles as $oldFile)
                    <img src="{{ asset('storage/' . $oldFile) }}"
            ...
            <div class="w-full py-2 overflow-x-auto">
                <div class="grid items-center grid-cols-6 gap-4 min-w-[700px]">
                    ...
                    @php
                        $rows = [1,2,3];
                        $fields = ['swl_tinggi_angkat_hook','beban_uji_load_chard','travelling','traversing','hasil','keterangan'];
                    @endphp
                    @foreach ($rows as $row)
                        @foreach ($fields as $field)
                            <div>
                                @php
                                    ...
                                    $fieldName = $field.$row;
                                @endphp
                                <input type="{{ $type }}" {{ $step }} name="{{ $fieldName }}" id="{{ $fieldName }}"
                                    class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error($fieldName) valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror"
                                    value="{{ $formKpCrane->$fieldName ?? '' }}">
                                @error($fieldName)
                                    <div class="text-xs text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
            ...
            <div>
                ...
                {{-- foto lama --}}
                @if($formKpCrane->foto_defleksi)
                @php $oldFiles = json_decode($formKpCrane->foto_defleksi, true); @endphp
                @if(is_array($oldFiles))
                <div class="flex flex-wrap gap-2 mb-2">
                    @foreach($oldFiles as $oldFile)
                    <img src="{{ asset('storage/' . $oldFile) }}"
            ...
            <div class="grid items-center grid-cols-3 gap-4">
                        ...
                        @foreach ($posisiOptions as $i)
                            <label class="flex-1 {{ $loop->last ? '' : 'border-r border-gray-400' }}">
                                <input type="radio" name="posisi_defleksi" value="{{ $i }}" class="hidden peer"
                                    {{ ($formKpCrane->posisi_defleksi ?? '') == $i ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <input type="number" step="any" name="single_girder_beban" id="single_girder_beban"
                        ...
                        value="{{ $formKpCrane->single_girder_beban ?? '' }}">
                ...
                <div>
                    <input type="number" step="any" name="single_girder_tanpa_beban" id="single_girder_tanpa_beban"
                        ...
                        value="{{ $formKpCrane->single_girder_tanpa_beban ?? '' }}">
                        ...
                        @foreach (array_slice($posisiDuaOptions, 0, 3) as $i)
                            <label class="flex-1 {{ $loop->last ? '' : 'border-r border-gray-400' }}">
                                <input type="radio" name="posisi_defleksi_dua" value="{{ $i }}" class="hidden peer"
                                    {{ ($formKpCrane->posisi_defleksi_dua ?? '') == $i ? 'checked' : '' }}>
                                <div class="py-2 text-center cursor-pointer peer-checked:bg-blue-500 peer-checked:text-white">
                                    {{ $i }}
                                </div>
                            </label>
            ...
            <div>
                ...
                <textarea name="catatan" id="catatan" placeholder="Catatan" rows="4"
                    class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm 
                            focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm 
                            @error('catatan') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror">{{ old('catatan', $formKpCrane->catatan) }}</textarea>
                @error('catatan')
                <div class="text-xs text-red-600">
                    {{ $message }}
                </div>
