            ...
            <form action="{{ route('form_kp.papa.crane.store', $jobOrderTool->id) }}" method="POST" class="space-y-4" enctype="multipart/form-data" onsubmit="return confirm('Simpan data?')">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="space-y-4">
                        ...
                        {{-- Tinggi Angkat (Meter) --}}
                        <div>
                            <input type="number" step="any" name="tinggi_angkat_meter" placeholder="Meter" id="tinggi_angkat_meter" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('tinggi_angkat_meter') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('tinggi_angkat_meter') }}">
                        ...
                        <div>
                            <input type="number" step="any" name="tinggi_angkat_lantai" placeholder="Lantai" id="tinggi_angkat_lantai" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('tinggi_angkat_lantai') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('tinggi_angkat_lantai') }}">
                ...
                {{-- Dimensi Pondasi --}}
                <div>
                    <input type="text" name="dimensi_pondasi" placeholder="Dimensi Pondasi" id="dimensi_pondasi" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('dimensi_pondasi') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('dimensi_pondasi') }}">
                ...
                {{-- Dimensi Sangkar --}}
                <div>
                    <input type="text" name="dimensi_sangkar" placeholder="Dimensi Sangkar" id="dimensi_sangkar" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('dimensi_sangkar') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('dimensi_sangkar') }}">
                ...
                <div>
                    <input type="text" name="dimensi_ruang_luncur" placeholder="Dimensi Ruang Luncur" id="dimensi_ruang_luncur" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('dimensi_ruang_luncur') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('dimensi_ruang_luncur') }}">
                ...
                {{-- foto_performance --}}
                <div>
                    <h2 class="block mb-1 text-base font-bold text-gray-700">Uji Penampilan/Performance</h2>
                    <label for="foto_performance" class="block mb-1 text-sm font-medium text-gray-700">Foto (opsional)</label>
                    <div id="foto_performance-preview" class="flex flex-wrap gap-2"></div>
                    <input type="file" name="foto_performance[]" id="foto_performance" accept="image/*" multiple onchange="previewImage(this, 'foto_performance-preview')" class="block w-full lg:w-[50%] px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('foto_performance') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror">
                ...
                <div class="w-full py-2 overflow-x-auto">
                    <div class="grid items-center grid-cols-5 gap-4 min-w-[700px]">
                        ...
                        {{-- Baris 2 --}}
                        <div>
                            <input type="text" name="hoisting_naik_turun1" id="hoisting_naik_turun1" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('hoisting_naik_turun1') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('hoisting_naik_turun1') }}">
                            @error('hoisting_naik_turun1') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>

                        <div>
                            <input type="text" name="jenis_uji1" id="jenis_uji1" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('jenis_uji1') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('jenis_uji1') }}">
                            @error('jenis_uji1') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>

                        <div>
                            <input type="text" name="bobot_beban1" id="bobot_beban1" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('bobot_beban1') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('bobot_beban1') }}">
                            @error('bobot_beban1') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>

                        <div>
                            <input type="text" name="indikasi_kerusakan1" id="indikasi_kerusakan1" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('indikasi_kerusakan1') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('indikasi_kerusakan1') }}">
                            @error('indikasi_kerusakan1') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>

                        <div>
                            <input type="text" name="hasil_performance1" id="hasil_performance1" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('hasil_performance1') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('hasil_performance1') }}">
                            @error('hasil_performance1') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>

                        {{-- Baris 3 --}}
                        <div>
                            <input type="text" name="hoisting_naik_turun2" id="hoisting_naik_turun2" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('hoisting_naik_turun2') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('hoisting_naik_turun2') }}">
                            @error('hoisting_naik_turun2') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>

                        <div>
                            <input type="text" name="jenis_uji2" id="jenis_uji2" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('jenis_uji2') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('jenis_uji2') }}">
                            @error('jenis_uji2') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>

                        <div>
                            <input type="text" name="bobot_beban2" id="bobot_beban2" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('bobot_beban2') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('bobot_beban2') }}">
                            @error('bobot_beban2') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>

                        <div>
                            <input type="text" name="indikasi_kerusakan2" id="indikasi_kerusakan2" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('indikasi_kerusakan2') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('indikasi_kerusakan2') }}">
                            @error('indikasi_kerusakan2') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>

                        <div>
                            <input type="text" name="hasil_performance2" id="hasil_performance2" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('hasil_performance2') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('hasil_performance2') }}">
                            @error('hasil_performance2') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>

                        {{-- Baris 4 --}}
                        <div>
                            <input type="text" name="hoisting_naik_turun3" id="hoisting_naik_turun3" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('hoisting_naik_turun3') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('hoisting_naik_turun3') }}">
                            @error('hoisting_naik_turun3') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>

                        <div>
                            <input type="text" name="jenis_uji3" id="jenis_uji3" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('jenis_uji3') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('jenis_uji3') }}">
                            @error('jenis_uji3') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>

                        <div>
                            <input type="text" name="bobot_beban3" id="bobot_beban3" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('bobot_beban3') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('bobot_beban3') }}">
                            @error('bobot_beban3') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>

                        <div>
                            <input type="text" name="indikasi_kerusakan3" id="indikasi_kerusakan3" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('indikasi_kerusakan3') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('indikasi_kerusakan3') }}">
                            @error('indikasi_kerusakan3') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>

                        <div>
                            <input type="text" name="hasil_performance3" id="hasil_performance3" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('hasil_performance3') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('hasil_performance3') }}">
                ...
                <div>
                    ...
                    <label for="foto_loadtest" class="block mt-3 mb-1 text-sm font-medium text-gray-700">Foto (opsional)</label>
                ...
                <div class="w-full py-2 overflow-x-auto">
                    <div class="grid items-center grid-cols-6 gap-4 min-w-[700px]">
                        ...
                        {{-- Baris 2 --}}
                        <div>
                            <input type="text" name="statis_dinamis1" id="statis_dinamis1" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('statis_dinamis1') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('statis_dinamis1') }}">
                        ...
                        <div>
                            <input type="text" name="hoisting1" id="hoisting1" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('hoisting1') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('hoisting1') }}">
                        ...
                        {{-- Baris 3 --}}
                        <div>
                            <input type="text" name="statis_dinamis2" id="statis_dinamis2" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('statis_dinamis2') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('statis_dinamis2') }}">
                            @error('statis_dinamis2') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>
                        <div>
                            <input type="text" name="tinggi_angkat_hook2" id="tinggi_angkat_hook2" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('tinggi_angkat_hook2') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('tinggi_angkat_hook2') }}">
                        ...
                        <div>
                            <input type="text" name="hoisting2" id="hoisting2" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('hoisting2') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('hoisting2') }}">
                        ...
                        {{-- Baris 4 --}}
                        <div>
                            <input type="text" name="statis_dinamis3" id="statis_dinamis3" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('statis_dinamis3') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('statis_dinamis3') }}">
                            @error('statis_dinamis3') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>
                        <div>
                            <input type="text" name="tinggi_angkat_hook3" id="tinggi_angkat_hook3" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('tinggi_angkat_hook3') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('tinggi_angkat_hook3') }}">
                            @error('tinggi_angkat_hook3') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>
                        <div>
                            <input type="text" name="swl_beban_uji3" id="swl_beban_uji3" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('swl_beban_uji3') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('swl_beban_uji3') }}">
                            @error('swl_beban_uji3') <div class="text-xs text-red-600">{{ $message }}</div> @enderror
                        </div>
                        <div>
                            <input type="text" name="hoisting3" id="hoisting3" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('hoisting3') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('hoisting3') }}">
