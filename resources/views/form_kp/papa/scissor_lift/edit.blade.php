            ...
            <form action="{{ route('form_kp.papa.scissor_lift.update', $formKpScissorLift->id) }}" method="POST" class="space-y-4" enctype="multipart/form-data" onsubmit="return confirm('Update data?')">
                    ...
                    <div class="w-full md:w-[48%]">
                        <div class="relative">
                            ...
                            <input id="datepicker-autohide" name="tanggal_pemeriksaan" placeholder="Tanggal Pemeriksaan" 
                                value="{{ old('tanggal_pemeriksaan', Carbon::parse($formKpScissorLift->tanggal_pemeriksaan)->format('d-m-Y')) }}"
                ...
                <div>
                    ...
                    <input type="text" name="nama_perusahaan" placeholder="Nama Perusahaan" id="nama_perusahaan" 
                        ...
                        value="{{ old('nama_perusahaan', $formKpScissorLift->nama_perusahaan) }}">
                ...
                <div>
                    ...
                    @if($formKpScissorLift->foto_shell)
                        @php $oldFiles = json_decode($formKpScissorLift->foto_shell, true); @endphp
                ...
                <div>
                    ...
                    <input type="text" name="ketidakbulatan" placeholder="Ketidak bulatan" id="ketidakbulatan" 
                        ...
                        value="{{ old('ketidakbulatan', $formKpScissorLift->ketidakbulatan) }}">
