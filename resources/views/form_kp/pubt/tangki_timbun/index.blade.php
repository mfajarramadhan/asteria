        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{{ $tangkiTimbun->jobOrderTool->jobOrder->nomor_jo }}</td>
                    ...
                    <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">
                        <div class="flex items-center gap-1">
                            ...
                            <a href="{{ route('form_kp.pubt.bejana_tekan.show' , $tangkiTimbun->id) }}">
                            ...
                            {{-- Update --}}
                            <button class="flex p-2 transition-all duration-500 rounded-full group item-center">
                            <a href="{{ route('form_kp.pubt.bejana_tekan.edit' , $tangkiTimbun->id) }}">
