        ...
        <div class="p-4 bg-white rounded-lg shadow-md">
            <form action="{{ route('form_kp.pubt.tangki_timbun.update', $formKpTangkiTimbun->id) }}" method="POST" class="space-y-4" enctype="multipart/form-data" onsubmit="return confirm('Update data?')">
                ...
                <div>
                    ...
                    {{-- foto lama --}}
                    @if($formKpTangkiTimbun->foto_informasi_umum)
                    @php $oldFiles = json_decode($formKpTangkiTimbun->foto_informasi_umum, true); @endphp
                ...
                <div>
                    ...
                    <input type="text" name="pabrik_pembuat" placeholder="Pabrik Pembuat" id="pabrik_pembuat" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('pabrik_pembuat') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('pabrik_pembuat', $formKpTangkiTimbun->pabrik_pembuat) }}">
                ...
                {{-- Tipe Tangki--}}
                <div>
                    <label for="jenis" class="block text-sm font-medium text-gray-700">Tipe Tangki</label>
                    <input type="text" name="jenis" placeholder="Tipe Tangki" id="jenis" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('jenis') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('jenis', $formKpTangkiTimbun->jenis) }}">
                    @error('jenis')
                    <div class="text-xs text-red-600">
                        {{ $message }}
                    </div>
                ...
                <div>
                    ...
                    <input type="text" name="lokasi" placeholder="Lokasi" id="lokasi" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('lokasi') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('lokasi', $formKpTangkiTimbun->lokasi) }}">
                    @error('lokasi')
                    <div class="text-xs text-red-600">
                        {{ $message }}
                    </div>
                ...
                <div>
                    ...
                    <input type="text" name="tahun_pembuatan" placeholder="Tahun Pembuatan" id="tahun_pembuatan" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('tahun_pembuatan') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('tahun_pembuatan', $formKpTangkiTimbun->tahun_pembuatan) }}">
                ...
                {{-- Tempat Pembuatan--}}
                <div>
                    <label for="tempat_pembuatan" class="block text-sm font-medium text-gray-700">Tempat Pembuatan</label>
                    <input type="text" name="tempat_pembuatan" placeholder="Tempat Pembuatan" id="tempat_pembuatan"
                        ...
                        value="{{ old('tempat_pembuatan', $formKpTangkiTimbun->tempat_pembuatan) }}">
                ...
                {{-- foto_visual --}}
                <div>
                    <h2 class="block mb-1 text-base font-bold text-gray-700">Visual</h2>
                ...
                {{-- foto_pengukuran --}}
                <div>
                    <h2 class="block mb-1 text-base font-bold text-gray-700">Pengukuran/Pengujian</h2>
                ...
                {{-- foto_komponen --}}
                <div>
                    <h2 class="block mb-1 text-base font-bold text-gray-700">Ketebalan</h2>
