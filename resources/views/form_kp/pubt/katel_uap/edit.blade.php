            ...
            <form action="{{ route('form_kp.pubt.katel_uap.update', $formKpKatelUap->id) }}" method="POST" class="space-y-4" enctype="multipart/form-data" onsubmit="return confirm('Update data?')">
                    ...
                    <div class="w-full md:w-[48%]">
                        <div class="relative">
                            ...
                            <input id="datepicker-autohide" name="tanggal_pemeriksaan" placeholder="Tanggal Pemeriksaan" 
                                value="{{ old('tanggal_pemeriksaan', Carbon::parse($formKpKatelUap->tanggal_pemeriksaan)->format('d-m-Y')) }}"
                ...
                <div>
                    ...
                    @if($formKpKatelUap->foto_shell)
                        @php $oldFiles = json_decode($formKpKatelUap->foto_shell, true); @endphp
                ...
                <div>
                    ...
                    <input type="text" name="ketidakbulatan" placeholder="Ketidak bulatan" id="ketidakbulatan" 
                        ...
                        value="{{ old('ketidakbulatan', $formKpKatelUap->ketidakbulatan) }}">
