<x-layout>
    ...
    <div class="grid grid-cols-1 gap-10 sm:grid-cols-2">
        ...
        <a href="{{ route('form_kp.pubt.bejana_tekan.index') }}" class="flex flex-col items-center p-4 transition-transform rounded-lg shadow-md bg-gradient-to-t from-yellow-700 to-yellow-500 transform-gpu hover:shadow-lg hover:scale-[103%]">
        ...
        <a href="{{ route('form_kp.pubt.bejana_tekan.index') }}" class="flex flex-col items-center p-4 transition-transform rounded-lg shadow-md bg-gradient-to-t from-red-700 to-red-500 transform-gpu hover:shadow-lg hover:scale-[103%]">
