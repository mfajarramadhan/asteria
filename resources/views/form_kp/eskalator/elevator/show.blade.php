<x-layout>
    ...
    <div class="p-4 bg-white rounded-lg shadow-md space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                <p class="text-gray-600 text-sm">Nama Perusahaan</p>
                <p class="font-semibold">{{ $data->nama_perusahaan ?? '-' }}</p>
            </div>
            <div>
            ...
            <div>
                <p class="text-gray-600 text-sm">Pabrik Pembuat</p>
                <p class="font-semibold">{{ $data->pabrik_pembuat ?? '-' }}</p>
            </div>
            <div>
            ...
            <div>
                <p class="text-gray-600 text-sm">Nomor Seri</p>
                <p class="font-semibold">{{ $data->nomor_seri ?? '-' }}</p>
            </div>
            <div>
                <p class="text-gray-600 text-sm">Kapasitas</p>
                <p class="font-semibold">{{ $data->kapasitas ?? '-' }}</p>
            </div>
            <div>
