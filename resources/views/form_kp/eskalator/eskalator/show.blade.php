    ...
    <div class="p-4 space-y-4 bg-white rounded-lg shadow-md">
        ...
        <div class="flex flex-wrap justify-between w-full gap-y-4">
            <div class="w-full md:w-[48%]">
                <div class="relative">
                    ...
                    <input disabled id="datepicker-autohide" value="{{ optional($formKpEskalator->tanggal_pemeriksaan)->format('d-m-Y') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5">
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm bg-gray-50">
                {{ $formKpEskalator->nama_perusahaan ?? '-' }}
            </div>
        </div>
        ...
        <div>
            ...
            @php
            $fotoShell = $formKpEskalator->foto_shell;
        ...
        <div>
            ...
            <div class="px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm bg-gray-50">
                {{ $formKpEskalator->ketidakbulatan ?? '-' }}
            </div>
        </div>
        ...
        <div>
            ...
            <textarea name="catatan" id="catatan" placeholder="Catatan" rows="3" disabled
                class="block w-full px-3 py-2 mt-1 leading-normal border border-gray-300 rounded-md shadow-sm bg-gray-50 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">{{ $formKpEskalator->catatan ?? '-' }}</textarea>
        </div>
