<x-layout>
    ...
    <div class="p-4 bg-white rounded-lg shadow-md">
        <form action="{{ route('form_kp.ipk.instalasi_fire_hydrant.store', $jobOrderTool->id) }}" method="POST" class="space-y-4" enctype="multipart/form-data" onsubmit="return confirm('Simpan data?')">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                 ...
                 <div class="col-span-2">
                     ...
                     <textarea name="catatan" rows="3" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm sm:text-sm">{{ old('catatan') }}</textarea>
                </div>
            </div>
