    ...
    <div class="p-4 bg-white rounded-lg shadow-md">
        <form action="{{ route('form_kp.ptp.motor_diesel.update', $formKpMotorDiesel->id) }}" method="POST" class="space-y-4" enctype="multipart/form-data" onsubmit="return confirm('Update data?')">
            ...
            <div>
                ...
                {{-- foto lama --}}
                @if($formKpMotorDiesel->foto_informasi_umum)
                @php $oldFiles = json_decode($formKpMotorDiesel->foto_informasi_umum, true); @endphp
            ...
            <div>
                ...
                <input type="text" name="pabrik_pembuat" placeholder="Pabrik Pembuat" id="pabrik_pembuat" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('pabrik_pembuat') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('pabrik_pembuat', $formKpMotorDiesel->pabrik_pembuat) }}">
            ...
            <div>
                ...
                <input type="text" name="jenis" placeholder="Jenis" id="jenis" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('jenis') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('jenis', $formKpMotorDiesel->jenis) }}">
                @error('jenis')
                <div class="text-xs text-red-600">
                    {{ $message }}
                </div>
            ...
            <div>
                ...
                <input type="text" name="tahun_pembuatan" placeholder="Tahun Pembuatan" id="tahun_pembuatan" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('tahun_pembuatan') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('tahun_pembuatan', $formKpMotorDiesel->tahun_pembuatan) }}">
            ...
            {{-- Pabrik Pembuat --}}
            <div>
                <label for="pabrik_pembuat_mesin" class="block text-sm font-medium text-gray-700">Pabrik Pembuat</label>
                <input type="text" name="pabrik_pembuat_mesin" placeholder="Pabrik Pembuat" id="pabrik_pembuat_mesin"
                    ...
                    value="{{ old('pabrik_pembuat_mesin', $formKpMotorDiesel->pabrik_pembuat_mesin) }}">
            ...
            {{-- Nomor Seri --}}
            <div>
                <label for="nomor_seri_mesin" class="block text-sm font-medium text-gray-700">Nomor Seri</label>
                <input type="text" name="nomor_seri_mesin" placeholder="Nomor Seri" id="nomor_seri_mesin"
                    class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('nomor_seri_mesin') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror"
                    value="{{ old('nomor_seri_mesin', $formKpMotorDiesel->nomor_seri_mesin) }}">
            ...
            {{-- Pabrik Pembuat --}}
            <div>
                <label for="pabrik_pembuat_generator" class="block text-sm font-medium text-gray-700">Pabrik Pembuat</label>
                <input type="text" name="pabrik_pembuat_generator" placeholder="Pabrik Pembuat" id="pabrik_pembuat_generator"
                    class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('pabrik_pembuat_generator') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror"
                    value="{{ old('pabrik_pembuat_generator', $formKpMotorDiesel->pabrik_pembuat_generator) }}">
            ...
            {{-- Nomor Seri --}}
            <div>
                <label for="nomor_seri_generator" class="block text-sm font-medium text-gray-700">Nomor Seri</label>
                <input type="text" name="nomor_seri_generator" placeholder="Nomor Seri" id="nomor_seri_generator"
                    class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('nomor_seri_generator') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror"
                    value="{{ old('nomor_seri_generator', $formKpMotorDiesel->nomor_seri_generator) }}">
