            ...
            <form action="{{ route('form_kp.ptp.pesawat_tenaga_produksi.update', $formKpPesawatTenagaProduksi->id) }}" method="POST" class="space-y-4" enctype="multipart/form-data" onsubmit="return confirm('Update data?')">
                ...
                <div>
                    ...
                    <input type="text" name="ketidakbulatan" placeholder="Ketidak bulatan" id="ketidakbulatan" 
                        ...
                        value="{{ old('ketidakbulatan', $formKpPesawatTenagaProduksi->ketidakbulatan) }}">
                ...
                <div>
                    ...
                    <input type="number" step="any" name="ketebalan_shell" placeholder="Ketebalan shell" id="ketebalan_shell" 
                        ...
                        value="{{ old('ketebalan_shell', $formKpPesawatTenagaProduksi->ketebalan_shell) }}">
                ...
                <div>
                    ...
                    <input type="number" step="any" name="diameter_shell" placeholder="Diameter (keliling)" id="diameter_shell" 
                        ...
                        value="{{ old('diameter_shell', $formKpPesawatTenagaProduksi->diameter_shell) }}">
                ...
                <div>
                    ...
                    <input type="number" step="any" name="panjang_shell" placeholder="Panjang shell" id="panjang_shell" 
                        ...
                        value="{{ old('panjang_shell', $formKpPesawatTenagaProduksi->panjang_shell) }}">
                    @error('panjang_shell')
                    <div class="text-xs text-red-600">
                        {{ $message }}
                    </div>
                ...
                <div>
                    ...
                    {{-- foto lama --}}
                    @if($formKpPesawatTenagaProduksi->foto_head)
                        @php $oldFiles = json_decode($formKpPesawatTenagaProduksi->foto_head, true); @endphp
                        @if(is_array($oldFiles))
                            <div class="flex flex-wrap gap-2 mb-2">
                                @foreach($oldFiles as $oldFile)
                                    <img src="{{ asset('storage/' . $oldFile) }}" 
                ...
                <div>
                    ...
                    <input type="number" step="any" name="diameter_head" placeholder="Ketebalan head" id="diameter_head" 
                        ...
                        value="{{ old('diameter_head', $formKpPesawatTenagaProduksi->diameter_head) }}">
                    @error('diameter_head')
                    <div class="text-xs text-red-600">
                        {{ $message }}
                    </div>
                ...
                <div>
                    ...
                    <input type="number" step="any" name="ketebalan_head" placeholder="Ketebalan head" id="ketebalan_head" 
                        ...
                        value="{{ old('ketebalan_head', $formKpPesawatTenagaProduksi->ketebalan_head) }}">
               ...
               {{-- Foto foto_pipa --}}
                <div>
                    ...
                    {{-- foto lama --}}
                    @if($formKpPesawatTenagaProduksi->foto_pipa)
                        @php $oldFiles = json_decode($formKpPesawatTenagaProduksi->foto_pipa, true); @endphp
                        @if(is_array($oldFiles))
                            <div class="flex flex-wrap gap-2 mb-2">
                                @foreach($oldFiles as $oldFile)
                                    <img src="{{ asset('storage/' . $oldFile) }}" 
                ...
                <div>
                    ...
                    <input type="number" step="any" name="diameter_pipa" placeholder="Diameter pipa (keliling)" id="diameter_pipa" 
                        ...
                        value="{{ old('diameter_pipa', $formKpPesawatTenagaProduksi->diameter_pipa) }}">
                    @error('diameter_pipa')
                    <div class="text-xs text-red-600">
                        {{ $message }}
                    </div>
                ...
                <div>
                    ...
                    <input type="number" step="any" name="ketebalan_pipa" placeholder="Ketebalan pipa" id="ketebalan_pipa" 
                        ...
                        value="{{ old('ketebalan_pipa', $formKpPesawatTenagaProduksi->ketebalan_pipa) }}">
                ...
                <div>
                    ...
                    <input type="number" step="any" name="panjang_pipa" placeholder="Panjang pipa" id="panjang_pipa" 
                        ...
                        value="{{ old('panjang_pipa', $formKpPesawatTenagaProduksi->panjang_pipa) }}">
                    @error('panjang_pipa')
                    <div class="text-xs text-red-600">
                        {{ $message }}
                    </div>
                ...
                <div>
                    ...
                    {{-- foto lama --}}
                    @if($formKpPesawatTenagaProduksi->foto_instalasi)
                        @php $oldFiles = json_decode($formKpPesawatTenagaProduksi->foto_instalasi, true); @endphp
                        @if(is_array($oldFiles))
                            <div class="flex flex-wrap gap-2 mb-2">
                                @foreach($oldFiles as $oldFile)
                                    <img src="{{ asset('storage/' . $oldFile) }}" 
                ...
                <div>
                    ...
                    <input type="number" step="any" name="diameter_instalasi" placeholder="Diameter (keliling)" id="diameter_instalasi" 
                        ...
                        value="{{ old('diameter_instalasi', $formKpPesawatTenagaProduksi->diameter_instalasi) }}">
                ...
                <div>
                    ...
                    <input type="number" step="any" name="ketebalan_instalasi" placeholder="Ketebalan" id="ketebalan_instalasi" 
                        ...
                        value="{{ old('ketebalan_instalasi', $formKpPesawatTenagaProduksi->ketebalan_instalasi) }}">
                ...
                <div>
                    ...
                    <input type="number" step="any" name="panjang_instalasi" placeholder="Panjang" id="panjang_instalasi" 
                        ...
                        value="{{ old('panjang_instalasi', $formKpPesawatTenagaProduksi->panjang_instalasi) }}">
                        ...
                        <div class="w-[30%] md:w-[25%] flex items-center justify-between">
                            <label class="flex items-center space-x-1">
                                <input type="radio" name="safety_valv_cal" value="1" 
                                    {{ old('safety_valv_cal', $formKpPesawatTenagaProduksi->safety_valv_cal) == 1 ? 'checked' : '' }}
                            ...
                            <label class="flex items-center space-x-1">
                                <input type="radio" name="safety_valv_cal" value="0" 
                                    {{ old('safety_valv_cal', $formKpPesawatTenagaProduksi->safety_valv_cal) == 0 ? 'checked' : '' }}
                                    class="text-black border-gray-300 focus:ring-blue-500">
                    ...
                    <div class="flex items-center w-full md:w-5/6">
                        ...
                        <div class="w-[30%] md:w-[25%]">
                            <input type="number" step="any" name="tekanan_kerja" id="tekanan_kerja" 
                                ...
                                value="{{ old('tekanan_kerja', $formKpPesawatTenagaProduksi->tekanan_kerja) }}">
                            @error('tekanan_kerja')
                            <div class="text-xs text-red-600">
                                {{ $message }}
                            </div>
                    ...
                    <div class="flex items-center w-full md:w-5/6">                    
                        ...
                        <div class="w-[30%] md:w-[25%]">
                            <input type="number" step="any" name="set_safety_valv" id="set_safety_valv" 
                                ...
                                value="{{ old('set_safety_valv', $formKpPesawatTenagaProduksi->set_safety_valv) }}">
                    ...
                    <div class="flex items-center w-full md:w-5/6">
                        ...
                        <div class="w-[30%] md:w-[25%]">
                            <input type="text" name="media_yang_diisikan" id="media_yang_diisikan" 
                                ...
                                value="{{ old('media_yang_diisikan', $formKpPesawatTenagaProduksi->media_yang_diisikan) }}">
