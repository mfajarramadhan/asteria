<x-layout>
    ...
    <div class="p-4 bg-white rounded-lg shadow-md">
        <form action="{{ route('job_orders.update', $jobOrder->id) }}" method="POST" class="space-y-4" enctype="multipart/form-data">
            ...
            {{-- Alamat Perusahaan --}}
            <div>
                <input type="text" @role('petugas') readonly class="block w-full px-3 py-2 mt-1 bg-gray-200 border border-gray-400 rounded-md shadow-sm cursor-not-allowed sm:text-sm" @endrole required name="alamat_perusahaan" placeholder="Alamat Perusahaan" id="alamat_perusahaan" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('alamat_perusahaan') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('alamat_perusahaan', $jobOrder->alamat_perusahaan) }}">
            ...
            {{-- Email --}}
            <div>
                <input type="email" @role('petugas') readonly class="block w-full px-3 py-2 mt-1 bg-gray-200 border border-gray-400 rounded-md shadow-sm cursor-not-allowed sm:text-sm" @endrole name="email" placeholder="Email" id="email" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('email') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('email', $jobOrder->email) }}">
                @error('email')
                <div class="text-xs text-red-600">{{ $message }}</div>
                @enderror
            </div>
            ...
            {{-- Contact Person --}}
            <div>
                <input type="tel" @role('petugas') readonly class="block w-full px-3 py-2 mt-1 bg-gray-200 border border-gray-400 rounded-md shadow-sm cursor-not-allowed sm:text-sm" @endrole name="contact_person" placeholder="Contact Person" id="contact_person" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('contact_person') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('contact_person', $jobOrder->contact_person) }}">
                ...
                <div class="flex justify-between gap-x-2 gap-y-4">
                    ...
                    <div class="inline-block w-full md:w-[48%]">
                        ...
                        <div class="relative">
                            ...
                            <input type="time" @role('petugas') readonly class="bg-gray-200 cursor-not-allowed border leading-none border-gray-400 text-gray-900 text-sm rounded-lg block w-full p-2.5" @endrole name="jam_bertemu" value="{{ old('jam_bertemu', $jobOrder->jam_bertemu) }}" id="jam_bertemu" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"/>
                        </div>
                    </div>
                    {{-- Jam Selesai --}}
                    <div class="inline-block w-full md:w-[48%]">
                        ...
                        <div class="relative">
                            ...
                            <input type="time" @role('petugas') readonly class="bg-gray-200 cursor-not-allowed border leading-none border-gray-400 text-gray-900 text-sm rounded-lg block w-full p-2.5" @endrole name="jam_selesai" value="{{ old('jam_selesai', $jobOrder->jam_selesai) }}" id="end-time" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"/>
                        </div>
                    </div>
                </div>
            </div>
            {{-- End Jam Bertemu --}}
             ...
             {{-- PIC Ditemui --}}
            <div>
                <input type="text" @role('petugas') readonly class="block w-full px-3 py-2 mt-1 bg-gray-200 border border-gray-400 rounded-md shadow-sm cursor-not-allowed sm:text-sm" @endrole name="pic_ditemui" placeholder="PIC Ditemui" id="pic_ditemui" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('pic_ditemui') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('pic_ditemui', $jobOrder->pic_ditemui) }}">
                @error('pic_ditemui')
                <div class="text-xs text-red-600">{{ $message }}</div>
                @enderror
            </div>
            ...
            {{-- Contact Person 2 --}}
            <div>
                <input type="text" @role('petugas') readonly class="block w-full px-3 py-2 mt-1 bg-gray-200 border border-gray-400 rounded-md shadow-sm cursor-not-allowed sm:text-sm" @endrole name="contact_person2" placeholder="Contact Person" id="contact_person2" class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('contact_person2') valid:border-red-600 valid:focus:border-red-600 valid:focus:ring-red-200 @enderror" value="{{ old('contact_person2', $jobOrder->contact_person2) }}">
                    ...
                    @if(old('tools'))
                        @foreach (old('tools') as $i => $tool)
                            <tr>
                                ...
                                <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">
                                    <input type="text" @role('petugas') readonly class="bg-gray-200 rounded-md cursor-not-allowed form-control" @endrole name="tools[{{ $i }}][kapasitas]" class="bg-gray-100 rounded-md form-control" value="{{ old("tools.$i.kapasitas") }}">
                                </td>
                                <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">
                                    <input type="text" @role('petugas') readonly class="bg-gray-200 rounded-md cursor-not-allowed form-control" @endrole name="tools[{{ $i }}][model]" class="bg-gray-100 rounded-md form-control" value="{{ old("tools.$i.model") }}">
                                </td>
                                <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">
                    ...
                    @elseif($jobOrder->tools->count())
                        @foreach ($jobOrder->tools as $i => $tool)
                            <tr>
                                ...
                                <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">
                                    <input type="text" @role('petugas') readonly class="bg-gray-200 rounded-md cursor-not-allowed form-control" @endrole name="tools[{{ $i }}][model]" class="bg-gray-100 rounded-md form-control" value="{{ $tool->pivot->model }}">
                                </td>
                                <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">
    ...
    @push('scripts')
        ...
        const style = document.createElement("style");
            ...
            document.getElementById('add-tool').addEventListener('click', function() {
                ...
                <tr>
                    <td class="w-full sm:w-[30%] min-w-[200px] px-4 py-3 text-sm text-gray-900 whitespace-nowrap">
                        <select @role('petugas') readonly class="bg-gray-200 cursor-not-allowed form-control" @endrole id="tool-select-${rowCount}" name="tools[${rowCount}][tool_id]" class="form-control" required>
                            <option value="">-- Pilih --</option>
                    ...
                    <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">
                        <input type="number" @role('petugas') readonly class="bg-gray-200 rounded-md cursor-not-allowed form-control" @endrole name="tools[${rowCount}][qty]" class="bg-gray-100 rounded-md form-control" min="1" required>
                    </td>
                    <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">
                        <select @role('petugas') readonly class="bg-gray-200 cursor-not-allowed form-control" @endrole name="tools[${rowCount}][status]" class="form-control" required>
