            ...
            <form action="{{ route('job_orders.store') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
                ...
                <div>
                    <label for="kelengkapan" class="block text-sm font-medium text-gray-700">
                        Kelengkapan Alat <span class="text-red-600">*</span>
                    </label>

                    <div
                        class="mt-1 border border-gray-300 rounded-md shadow-sm px-3 py-2 
                            focus:outline-none focus:ring-blue-500 focus:border-blue-500 
                            sm:text-sm @error('kelengkapan') valid:border-red-600 
                            valid:focus:border-red-600 valid:focus:ring-red-200 @enderror space-y-2">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <input type="checkbox" id="kelengkapan_manual_book" name="kelengkapan[]" value="manual_book"
                                {{ is_array(old('kelengkapan')) && in_array('manual_book', old('kelengkapan')) ? 'checked' : '' }}
                                class="w-5 h-5">
                            <input type="number" placeholder="Qty..." name="qty[manual_book]" value="{{ old('qty.manual_book') }}"
                                class="w-20 px-2 py-1 text-sm border border-gray-300 rounded-md sm:flex-1"> {{-- kecil di mobile, full di web --}}
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <input type="checkbox" id="kelengkapan_layout" name="kelengkapan[]" value="layout"
                                {{ is_array(old('kelengkapan')) && in_array('layout', old('kelengkapan')) ? 'checked' : '' }}
                                class="w-5 h-5">
                            <input type="number" placeholder="Qty..." name="qty[layout]" value="{{ old('qty.layout') }}"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <input type="checkbox" id="kelengkapan_maintenance_report" name="kelengkapan[]" value="maintenance_report"
                                {{ is_array(old('kelengkapan')) && in_array('maintenance_report', old('kelengkapan')) ? 'checked' : '' }}
                                class="w-5 h-5">
                            <input type="number" placeholder="Qty..." name="qty[maintenance_report]" value="{{ old('qty.maintenance_report') }}"
                                class="w-20 px-2 py-1 text-sm border border-gray-300 rounded-md sm:flex-1">
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <input type="checkbox" id="kelengkapan_surat_permohonan" name="kelengkapan[]" value="surat_permohonan"
                                {{ is_array(old('kelengkapan')) && in_array('surat_permohonan', old('kelengkapan')) ? 'checked' : '' }}
                                class="w-5 h-5">
                            <input type="number" placeholder="Qty..." name="qty[surat_permohonan]" value="{{ old('qty.surat_permohonan') }}"
                                class="w-20 px-2 py-1 text-sm border border-gray-300 rounded-md sm:flex-1">
                        </div>
                    </div>
                    @error('kelengkapan')
