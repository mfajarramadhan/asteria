    ...
    <x-slot:subtitle>{{ $subtitle }}</x-slot:subtitle>
        <div class="p-4 bg-white rounded-lg shadow-md">
            <form action="{{ route('tools.store') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
                ...
                {{-- Submit --}}
                <button type="submit" class="px-3 py-2 font-bold text-white transition-transform rounded-lg bg-gradient-to-t from-blue-500 to-blue-400 transform-gpu hover:shadow-md hover:scale-[103%]">
                    Simpan
                </button>
                {{-- End Submit --}}
            </form>
