        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">{{ $user->jabatan }}</td>
                    ...
                    <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap">
                         <form action="{{ route('superadmin.destroyUser', $user->id) }}" method="POST" onsubmit='return confirm("Yakin menghapus pengguna dengan nama \"{{ $user->nama }}\"? Data yang dihapus tidak dapat dikembalikan!");'>
                            @csrf
                            @method('DELETE')
